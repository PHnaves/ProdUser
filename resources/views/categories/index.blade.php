          ...
          <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
            <div class="max-w-xl lg:max-w-lg">
              ...
              <div class="mt-3 flex max-w-md gap-x-4">
                ...
                <form class="flex space-x-5" action="{{ route('categories.store') }}" method="post">
                    @csrf
                    ...
                    <button type="submit" class="flex-none rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Criar Nova Categoria</button>
                </form>
              </div>
            </div>
